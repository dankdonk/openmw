...
NiBtOgre::FgCtl::FgCtl(const Ogre::String& name, const Ogre::String& group)
    : mFgStream(name), mGroup(group), mName(name)
{
}

NiBtOgre::FgCtl::~FgCtl()
{
}

// only called if this resource is not being loaded from a ManualResourceLoader
void NiBtOgre::FgCtl::loadImpl()
{
    ...
    // TODO: remainder of si.ctl
}

void NiBtOgre::FgCtl::readLinearControls(uint32_t& numControls, uint32_t numModes,
...
void NiBtOgre::FgCtl::readOffsetLinearControls(uint32_t numModes,
