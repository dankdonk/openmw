...
#include "inventorystoretes4.hpp"
...
MWWorld::InventoryStoreTES4::InventoryStoreTES4()
    : InventoryStore ()
{
    //initSlots (mSlots);
}

MWWorld::InventoryStoreTES4::InventoryStoreTES4 (const InventoryStoreTES4& store)
    : InventoryStore (store)
{
    //copySlots (store);
}

MWWorld::InventoryStoreTES4& MWWorld::InventoryStoreTES4::operator= (const InventoryStoreTES4& store)
{
...
void MWWorld::InventoryStoreTES4::autoEquip (const MWWorld::Ptr& actor)
{
