...
#include "inventorystoretes5.hpp"
...
MWWorld::InventoryStoreTES5::InventoryStoreTES5()
    : InventoryStore ()
{
    //initSlots (mSlots);
}

MWWorld::InventoryStoreTES5::InventoryStoreTES5 (const InventoryStoreTES5& store)
    : InventoryStore (store)
{
    //copySlots (store);
}

MWWorld::InventoryStoreTES5& MWWorld::InventoryStoreTES5::operator= (const InventoryStoreTES5& store)
{
...
void MWWorld::InventoryStoreTES5::autoEquip (const MWWorld::Ptr& actor)
{
    ...
    for (ContainerStoreIterator iter (begin()); iter!=end(); ++iter)
    {
        ...
        for (; iter2 != itemsSlots.first.end(); ++iter2)
        {
            ...
            slots_[*iter2] = iter;
            //break;  // for TES5 an item can occupy more than one slot
        }
    }
