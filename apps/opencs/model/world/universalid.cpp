...
namespace
{
    ...
    static const TypeData sNoArg[] =
    {
        ...
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignWorlds, "Foreign Worlds", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignCells, "Foreign Cells", 0 },
        ...
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignMiscItems, "Foreign Misc Items Table", ":./container.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignActivators, "Foreign Activator Table", ":./container.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignArmors, "Foreign Armor Table", ":./armor.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignNpcs, "Foreign Npc Table", ":./npc.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignFloras, "Foreign Flora Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignGrasses, "Foreign Grass Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignTrees, "Foreign Trees Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignLights, "Foreign Lights Table", ":./light.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignBooks, "Foreign Books Table", ":./book.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignFurnitures, "Foreign Furniture Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignSounds, "Foreign Sounds Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignWeapons, "Foreign Weapons Table", ":./weapon.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignDoors, "Foreign Doors Table", ":./door.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignAmmos, "Foreign Ammos Table", ":/weapon.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignClothings, "Foreign Clothings Table", ":./clothing.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignPotions, "Foreign Potions Table", ":./potion.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignApparatuses, "Foreign Apparatuses Table", ":./apparatus.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignIngredients, "Foreign Ingredients Table", ":./ingredient.png" },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignSigilStones, "Foreign SigilStones Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignSoulGems, "Foreign SoulGems Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignKeys, "Foreign Keys Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignHairs, "Foreign Hairs Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignEyesSet, "Foreign Eyes Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignCreatures, "Foreign Creature Table", 0 },
        { CSMWorld::UniversalId::Class_RecordList, CSMWorld::UniversalId::Type_ForeignLvlCreatures, "Foreign Lvl Creature Table", 0 },
    ...
    static const TypeData sIdArg[] =
    {
        ...
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignMiscItem, "Foreign Misc Item", ":./container.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignActivator, "Foreign Activator", ":./container.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignArmor, "Foreign Armor", ":./armor.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignNpc, "Foreign Npc", ":./npc.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignFlora, "Foreign Flora", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignGrass, "Foreign Grass", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignTree, "Foreign Tree", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignLight, "Foreign Light", ":./light.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignBook, "Foreign Book", ":./book.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignFurniture, "Foreign Furniture", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignSound, "Foreign Sound", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignWeapon, "Foreign Weapon", ":./weapon.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignDoor, "Door", ":./door.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignAmmo, "Ammo", ":./weapon.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignClothing, "Clothing", ":./clothing.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignPotion, "Potion", ":./potion.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignApparatus, "Apparatus", ":./apparatus.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignIngredient, "Ingredient", ":./ingredient.png" },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignSigilStone, "Sigil Stone", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignSoulGem, "Soul Gem", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignKey, "Key", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignHair, "Hair", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignEyes, "Eyes", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignCreature, "Creature", 0 },
        { CSMWorld::UniversalId::Class_Record, CSMWorld::UniversalId::Type_ForeignLvlCreature, "Lvl Creature", 0 },
