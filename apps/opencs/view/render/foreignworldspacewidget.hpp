#ifndef OPENCS_VIEW_FOREIGNWORLDSPACEWIDGET_H
#define OPENCS_VIEW_FOREIGNWORLDSPACEWIDGET_H
...
namespace CSVRender
{
    ...
    class ForeignWorldspaceWidget : public WorldspaceWidget
    {
            ...
            std::map<CSMWorld::CellCoordinates, ForeignCell *> mCells;
        ...
        private:
            ...
            ForeignCell *findCell(const std::string &cellId);

        public:

            ForeignWorldspaceWidget (QWidget *parent, CSMDoc::Document& document);
            ...
            virtual ~ForeignWorldspaceWidget();
